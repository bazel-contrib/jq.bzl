...
def _jq_toolchains_repo_impl(rctx):
    ...
    starlark_content = """# @generated by @jq.bzl//jq/toolchain:toolchain.bzl
...
""".format(TOOLCHAIN_TYPE)
    ...
    build_content = """# @generated by @jq.bzl//jq/toolchain:toolchain.bzl
#
...
def _jq_host_alias_repo(rctx):
    ...
    # Base BUILD file for this repository
    rctx.file("BUILD.bazel", """# @generated by @jq.bzl//jq/toolchain:toolchain.bzl
...
copy_file(
    name = "jq",
    src = "@{toolchains_repo_name}_{platform}//:jq{ext}",
    out = "jq{ext}",
    is_executable = True
)
""".format(
        toolchains_repo_name = rctx.attr.toolchains_repo_name,
...
jq_host_alias_repo = repository_rule(
    _jq_host_alias_repo,
    attrs = {
        "toolchains_repo_name": attr.string(doc = "Base name for the toolchains repository."),
    },
